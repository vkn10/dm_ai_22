...
print("Модель с предобучением:")
print(classification_report(y_test, y_pred2))

# Сравнение точности
accuracy_without_pretraining = report1['accuracy']
accuracy_with_pretraining = report2['accuracy']

print(f"Точность модели без предобучения: {accuracy_without_pretraining:.4f}")
print(f"Точность модели с предобучением: {accuracy_with_pretraining:.4f}")
...
plot_history(history2, 'Модель с предобучением')
